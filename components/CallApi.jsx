...
const CallApi = ({
  ...
  function generateJS() {
    ...
    const codeString = `this.${shapeNameToUse}=async function(){let endpoint = ${endpointString};let inputVars= ${inputVarsString};let outputVars = await IVR.callAPI('${shapeName}',endpoint,inputVars);${outputVarsString}};`;
